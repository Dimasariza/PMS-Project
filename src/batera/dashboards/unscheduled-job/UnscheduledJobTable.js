...
const UnscheduledJobTable = ({ scheduledJobList, handleOpen }) => {
  ...
  const filteredList = applyFilters(scheduledJobList, filters);
...
UnscheduledJobTable.propTypes = {
  scheduledJobList: PropTypes.array.isRequired
};

UnscheduledJobTable.defaultProps = {
  scheduledJobList: []
};

export default UnscheduledJobTable;
