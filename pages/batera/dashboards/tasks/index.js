...
function DashboardBateraTasks() {
  ...
  return (
    <>
      <Head>
        <title>Tasks Dashboard Batera</title>
      </Head>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
DashboardBateraTasks.getLayout = (page) => <SidebarLayout>{page}</SidebarLayout>;

export default DashboardBateraTasks;
